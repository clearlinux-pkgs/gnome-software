...
Version  : 46.4
Release  : 91
URL      : https://download.gnome.org/sources/gnome-software/46/gnome-software-46.4.tar.xz
Source0  : https://download.gnome.org/sources/gnome-software/46/gnome-software-46.4.tar.xz
...
%prep
%setup -q -n gnome-software-46.4
cd %{_builddir}/gnome-software-46.4
pushd ..
cp -a gnome-software-46.4 buildavx2
popd
pushd ..
cp -a gnome-software-46.4 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722621442
