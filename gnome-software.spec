...
Source0  : https://download.gnome.org/sources/gnome-software/43/gnome-software-43.5.tar.xz
...
%prep
%setup -q -n gnome-software-43.5
cd %{_builddir}/gnome-software-43.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677859959
