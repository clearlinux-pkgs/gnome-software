...
Source0  : https://download.gnome.org/sources/gnome-software/41/gnome-software-41.3.tar.xz
...
%prep
%setup -q -n gnome-software-41.3
cd %{_builddir}/gnome-software-41.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641846952
...
cp %{_builddir}/gnome-software-41.3/COPYING %{buildroot}/usr/share/package-licenses/gnome-software/4cc77b90af91e615a64ae04893fdffa7939db84c
