...
Version  : 3.34.1
Release  : 46
URL      : https://download.gnome.org/sources/gnome-software/3.34/gnome-software-3.34.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-software/3.34/gnome-software-3.34.1.tar.xz
...
%prep
%setup -q -n gnome-software-3.34.1
cd ..
%setup -q -T -D -n gnome-software-3.34.1 -b 1
mkdir -p clearlinux
cp -r %{_topdir}/BUILD/clr-software-icons-1/* %{_topdir}/BUILD/gnome-software-3.34.1/clearlinux
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570482841
