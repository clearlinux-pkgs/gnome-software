...
Source0  : https://download.gnome.org/sources/gnome-software/48/gnome-software-48.1.tar.xz
...
%prep
%setup -q -n gnome-software-48.1
cd %{_builddir}/gnome-software-48.1
pushd ..
cp -a gnome-software-48.1 buildavx2
popd
pushd ..
cp -a gnome-software-48.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744383392
