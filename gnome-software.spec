...
Version  : 45.2
Release  : 82
URL      : https://download.gnome.org/sources/gnome-software/45/gnome-software-45.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-software/45/gnome-software-45.2.tar.xz
...
%prep
%setup -q -n gnome-software-45.2
cd %{_builddir}/gnome-software-45.2
pushd ..
cp -a gnome-software-45.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703275492
