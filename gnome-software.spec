...
Source0  : https://download.gnome.org/sources/gnome-software/47/gnome-software-47.0.tar.xz
...
%prep
%setup -q -n gnome-software-47.0
cd %{_builddir}/gnome-software-47.0
pushd ..
cp -a gnome-software-47.0 buildavx2
popd
pushd ..
cp -a gnome-software-47.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726767018
