...
Source0  : https://download.gnome.org/sources/gnome-software/46/gnome-software-46.3.tar.xz
...
%prep
%setup -q -n gnome-software-46.3
cd %{_builddir}/gnome-software-46.3
pushd ..
cp -a gnome-software-46.3 buildavx2
popd
pushd ..
cp -a gnome-software-46.3 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719586213
