...
%prep
%setup -q -n gnome-software-46.0
cd %{_builddir}/gnome-software-46.0
pushd ..
cp -a gnome-software-46.0 buildavx2
popd
pushd ..
cp -a gnome-software-46.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710602594
