...
Source0  : https://download.gnome.org/sources/gnome-software/3.30/gnome-software-3.30.1.tar.xz
...
%prep
%setup -q -n gnome-software-3.30.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537944740
