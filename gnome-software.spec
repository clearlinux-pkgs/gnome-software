...
Version  : 3.30.5
Release  : 8
URL      : https://download.gnome.org/sources/gnome-software/3.30/gnome-software-3.30.5.tar.xz
Source0  : https://download.gnome.org/sources/gnome-software/3.30/gnome-software-3.30.5.tar.xz
...
%prep
%setup -q -n gnome-software-3.30.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1542609986
