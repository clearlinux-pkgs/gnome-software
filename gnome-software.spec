...
Version  : 47.1
Release  : 93
URL      : https://download.gnome.org/sources/gnome-software/47/gnome-software-47.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-software/47/gnome-software-47.1.tar.xz
...
%prep
%setup -q -n gnome-software-47.1
cd %{_builddir}/gnome-software-47.1
pushd ..
cp -a gnome-software-47.1 buildavx2
popd
pushd ..
cp -a gnome-software-47.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728573237
