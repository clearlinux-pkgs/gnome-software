...
Version  : 40.1
Release  : 54
URL      : https://download.gnome.org/sources/gnome-software/40/gnome-software-40.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-software/40/gnome-software-40.1.tar.xz
...
%prep
%setup -q -n gnome-software-40.1
cd %{_builddir}/gnome-software-40.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622759972
...
cp %{_builddir}/gnome-software-40.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-software/4cc77b90af91e615a64ae04893fdffa7939db84c
