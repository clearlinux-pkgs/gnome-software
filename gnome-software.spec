...
Version  : 3.28.2
Release  : 1
URL      : https://download.gnome.org/sources/gnome-software/3.28/gnome-software-3.28.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-software/3.28/gnome-software-3.28.2.tar.xz
...
%prep
%setup -q -n gnome-software-3.28.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1532455124
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain -Denable-packagekit=false -Denable-ubuntuone=false -Denable-ubuntu-reviews=false -Denable-snap=false -Denable-gtk-doc=false  builddir
ninja -v -C builddir
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/gs-plugins-11/libgs_plugin_appstream.so
/usr/lib64/gs-plugins-11/libgs_plugin_desktop-categories.so
/usr/lib64/gs-plugins-11/libgs_plugin_desktop-menu-path.so
/usr/lib64/gs-plugins-11/libgs_plugin_dpkg.so
/usr/lib64/gs-plugins-11/libgs_plugin_dummy.so
/usr/lib64/gs-plugins-11/libgs_plugin_epiphany.so
/usr/lib64/gs-plugins-11/libgs_plugin_fedora-pkgdb-collections.so
/usr/lib64/gs-plugins-11/libgs_plugin_flatpak.so
/usr/lib64/gs-plugins-11/libgs_plugin_fwupd.so
/usr/lib64/gs-plugins-11/libgs_plugin_generic-updates.so
/usr/lib64/gs-plugins-11/libgs_plugin_hardcoded-blacklist.so
/usr/lib64/gs-plugins-11/libgs_plugin_hardcoded-featured.so
/usr/lib64/gs-plugins-11/libgs_plugin_hardcoded-popular.so
/usr/lib64/gs-plugins-11/libgs_plugin_icons.so
/usr/lib64/gs-plugins-11/libgs_plugin_key-colors-metadata.so
/usr/lib64/gs-plugins-11/libgs_plugin_key-colors.so
/usr/lib64/gs-plugins-11/libgs_plugin_modalias.so
/usr/lib64/gs-plugins-11/libgs_plugin_odrs.so
/usr/lib64/gs-plugins-11/libgs_plugin_os-release.so
/usr/lib64/gs-plugins-11/libgs_plugin_provenance-license.so
/usr/lib64/gs-plugins-11/libgs_plugin_provenance.so
/usr/lib64/gs-plugins-11/libgs_plugin_repos.so
/usr/lib64/gs-plugins-11/libgs_plugin_rewrite-resource.so
/usr/lib64/gs-plugins-11/libgs_plugin_shell-extensions.so
/usr/lib64/gs-plugins-11/libgs_plugin_steam.so
